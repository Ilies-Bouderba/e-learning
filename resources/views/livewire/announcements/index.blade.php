                    ...
                    <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                        <div style="flex: 1;">
                            <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 0.75rem;">
                                ...
                                <div>
                                    <h3 class="ann-title" style="font-family: var(--font-head); font-weight: 800; font-size: 1.1rem; margin: 0; cursor: pointer; color: var(--c-dark);"
                                        @click="selected = {{ json_encode($ann) }}; open = true">
                                        {{ $ann->title }}
                                    </h3>
                                    <div class="ann-date" style="font-size: 0.75rem; color: var(--c-muted); margin-top: 0.25rem;">
                                        Posted {{ $ann->posted_at->diffForHumans() }} • {{ $ann->posted_at->format('F j, Y, g:i a') }}
                                    </div>
                                </div>
                            </div>
                            <div class="ann-content" style="font-size: 0.95rem; line-height: 1.6; color: var(--c-dark); margin-top: 0.5rem;">
